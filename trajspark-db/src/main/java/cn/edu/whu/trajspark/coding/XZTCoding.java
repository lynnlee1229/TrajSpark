...
public class XZTCoding {
  ...
  public List<TimeIndexRange> ranges(TimeLine timeLine, TimePeriod timePeriod) {
    List<TimeLine> timeLineList = new ArrayList<>(1);
    timeLineList.add(timeLine);
    return ranges(timeLineList, timePeriod);
  }

  public List<TimeIndexRange> ranges(List<TimeLine> timeLineList, TimePeriod timePeriod) {
