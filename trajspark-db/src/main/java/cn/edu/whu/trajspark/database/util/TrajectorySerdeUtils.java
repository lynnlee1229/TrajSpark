...
public class TrajectorySerdeUtils {
  ...
  public static void addFeaturesToTrajectory(Trajectory trajectory, Result result){
    ...
    if(result.containsColumn(COLUMN_FAMILY, EXT_VALUES_QUALIFIER)){
      ...
      HashMap<String, Object> extendValueStr = (HashMap<String, Object>) SerializerUtils.deserializeObject(extendValue,
          HashMap.class);
  ...
  private static TrajFeatures bytesToTrajFeatures(byte[] startTime, byte[] endTime,
    ...
    return new TrajFeatures(startTimeStr, endTimeStr, startPointStr, endPointStr,  1, mbrStr,
        speedStr, lengthStr);
  }
   ...
   */
  private static Put addBasicTrajectoryInfos(IndexMeta indexMeta, Trajectory trajectory) throws IOException {
