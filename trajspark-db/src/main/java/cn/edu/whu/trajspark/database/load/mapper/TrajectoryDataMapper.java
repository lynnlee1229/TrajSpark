...
import static cn.edu.whu.trajspark.database.util.TrajectorySerdeUtils.TRAJECTORY_ID_QUALIFIER;
...
import org.apache.hadoop.hbase.regionserver.StoreFile.Comparators;
...
public class TrajectoryDataMapper {
  ...
  public static Trajectory mapHBaseResultToTrajectory(Result result) throws IOException {
    return TrajectorySerdeUtils.getTrajectory(result);
  }
