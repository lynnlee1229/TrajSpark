...
public class IDTemporalQuery extends AbstractQuery {
  ...
  public List<Trajectory> executeQuery(List<RowKeyRange> rowKeyRanges) throws IOException {
    ...
    List<TemporalQueryWindow> temporalQueryWindows = buildProtoTemporalWindows(temporalQueryCondition);
  ...
  public static List<TemporalQueryWindow> buildProtoTemporalWindows(TemporalQueryCondition temporalQueryCondition) {
